                ...
                <div className='h-auto flex flex-col lg:flex-row-reverse gap-4'>
                    <div className='h-[300px] w-[300px] lg:h-[500px] lg:w-[500px] bg-slate-200 relative p-2'>
                        ...
                        {/**Product Zoom */}
                        {
                            ...
                            zoomImage && (
                                <div className='hidden lg:block absolute min-w-700px] min-h-[500px] overflow-hidden bg-slate-200 p-1 -right-[710px] top-0'>
                                    <div
                                        className='w-full h-full min-h-[500px] min-w-[700px]  mix-blend-multiply scale-150'
                                        style={{
                                ...
                                <div className='flex gap-2 lg:flex-col overflow-scroll scrollbar-none h-full'>
                                    {
                                        productImageListLoading.map((el,index) => {
                                            return (
                                                <div className='md:h-28 md:w-28 h-20 w-20 bg-slate-200 rounded animate-pulse' key={"loadingImage"+index}>
                                ...
                                <div className='flex gap-2 lg:flex-col overflow-scroll scrollbar-none h-full'>
                                    {
                                        data?.productImage?.map((imageURl, index) => {
                                            return (
                                                <div className='h-20 w-20 md:h-28 md:w-28 bg-slate-200 rounded p-1' key={imageURl}>
                                                    <img src={imageURl} alt="" className='w-full h-full object-scale-down mix-blend-multiply cursor-pointer' onClick={() => handleMouseEnterProduct(imageURl)} onMouseEnter={() => handleMouseEnterProduct(imageURl)} />
                                                </div>
                                            )
                                        })
                                    }
                ...
                {/**Product details */}
                {
                    loading ? (
                        <div className='grid w-full gap-1'>
                            ...
                            <div className='text-red-600 bg-slate-200 animate-pulse h-6 w-full lg:h-8 flex items-center gap-1'>

                            </div>

                            <div className='flex items-center gap-2 text-2xl font-medium my-1 lg:h-8 h-6 w-full animate-pulse lg:text-3xl'>
                            ...
                            <div>
                                <p className='text-slate-600 font-medium my-1 h-6 lg:h-8 animate-pulse bg-slate-200 rounded'></p>
                                <p className='h-10 lg:h-12 animate-pulse bg-slate-200 rounded'></p>
                            </div>
                        </div>
                    ) : (
