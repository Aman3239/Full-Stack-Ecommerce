        ...
        <div className='fixed w-full h-full bg-slate-200 bg-opacity-35 top-0 bottom-0 left-0 right-0 flex justify-center items-center'>
            <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[82%] overflow-hidden'>
                ...
                <form action="" className='grid p-4 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
                    ...
                    <select required name="category" id="category" value={data.category} onChange={handleOnChange} className='p-2 bg-slate-100 border rounded '>
                    ...
                    id="description" 
                    className='h-28 bg-slate-100 border rounded resize-none p-1' 
