        ...
        <header className='h-16 shadow-lg bg-white fixed w-full z-40'>
            <div className="h-full mx-auto container flex items-center justify-between">
                ...
                <div className='hidden lg:flex items-center w-full justify-between max-w-sm border rounded-full pl-2 focus-within:shadow'>
                    <input className='w-full outline-none' type="text" placeholder='search product here...' onChange={handleSearch} value={search} />
                    <div className=' text-lg min-w-[50px] h-8 bg-red-600 flex items-center justify-center rounded-r-full cursor-pointer'>
                        <GrSearch />
                    </div>
                </div>

                <div className='mx-3 flex items-center gap-5 cursor-pointer'>
